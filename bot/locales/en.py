...
MESSAGES = {
    ...
    "COACH_WETTIDEE_LAEUFT": "A bet is still running – the next one comes once that one is decided.",
    ...
    "COACH_WETTIDEE_GESENDET": "📨 Sent – the bet is in his hands now. Verdict in {tage} day(s), {einsatz} points on top.",
