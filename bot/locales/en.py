...
MESSAGES = {
    ...
    # --- Currency ⭐: ranks, deductions, threshold push, savings goal, dominant's bet ---
    "RANG_ZEILE_MIT_NAECHSTEM": "{titel} · next rank {naechster} from {ab} points",
    "RANG_ZEILE_HOECHSTER": "{titel} · highest rank",
    "SPARZIEL_ZEILE": "{wunsch} · {stand}/{preis} P",
    "RANG_AUF": "🏅 You rise to {titel} ({stand} points). I see it. Don't let it go to your head.",
    "RANG_AB": "📉 You drop back to {titel} ({stand} points). You brought that on yourself.",
    "SCHWELLE_KOPF": "⭐ {stand} points, the {schwelle} are full. Rank: {rang}.",
    "SCHWELLE_SPARZIEL": "🎯 Savings goal: {zeile}",
    "SCHWELLE_SHOP": "If you want to spend them, here are the two most expensive things you can afford. Otherwise keep saving.",
    "BUTTON_ABZUG": "−{betrag} P",
    "ABZUG_VERALTET": "That deduction is no longer possible – already booked or too old.",
    "ABZUG_DOM_OK": "⭐ {betrag} points deducted, he is now at {stand}.",
    "ABZUG_SUB": "📉 I took {betrag} points from you. Balance: {stand}. Remember what for.",
    "ABZUG_NICHT_ERLEDIGT_ZEILE": "📉 That costs you {betrag} points. Balance: {stand}.",
    "WUNSCHPREIS_FRAGE": "🛒 New wish from {sub_nom}: “{wunsch}”\n\nWhat should he save for it? Without your tap it stays a wish without a price.",
    "WUNSCHPREIS_VERALTET": "This wish question is no longer current.",
    "WUNSCHPREIS_WEG": "The wish “{wunsch}” is no longer on the list.",
    "WUNSCHPREIS_GESETZT": "🎯 “{wunsch}” now costs him {preis} points. As soon as he has them, I'll ask you.",
    "SPARZIEL_NEU_SUB": "🎯 Your savings goal: “{wunsch}” for {preis} points. You are at {stand}.",
    "SPARZIEL_ERREICHT": "🎯 {sub_nom} has {preis} points together for “{wunsch}” (balance {stand}).\n\nGrant it? Then I'll book the points and he knows it's coming.",
    "BUTTON_SPARZIEL_GEWAEHREN": "✅ Grant",
    "BUTTON_SPARZIEL_SPAETER": "⏳ Not yet",
    "SPARZIEL_VERALTET": "This question is no longer current.",
    "SPARZIEL_SPAETER": "👍 Stays open – I'll ask again in {tage} days at the earliest.",
    "SPARZIEL_WEG": "The wish “{wunsch}” has no price anymore or is no longer on the list.",
    "SPARZIEL_ZU_WENIG": "He no longer has enough for “{wunsch}”: {stand} of {preis} points.",
    "SPARZIEL_GEWAEHRT_DOM": "✅ Granted: “{wunsch}” for {preis} points, he is now at {stand}. Once it's there, add it to the inventory with “+ …”.",
    "SPARZIEL_GEWAEHRT_SUB": "🎁 You saved up for “{wunsch}” – {preis} points are gone, balance {stand}. When and how you get it is my call.",
    "WETTE_URTEIL_FRAGE": "🎲 The deadline of your bet is up. Well? Honestly – I'll find out anyway. ({einsatz} points are on it.)",
    "BUTTON_WETTE_GEWONNEN": "🏆 Won",
    "BUTTON_WETTE_VERLOREN": "💀 Lost",
    "WETTE_URTEIL_VERALTET": "This bet is already decided.",
    "WETTE_GEWONNEN_SUB": "🏆 Won. {einsatz} points added, balance {stand}. Enjoy it, that doesn't happen often.",
    "WETTE_VERLOREN_SUB": "💀 Lost. {einsatz} points gone, balance {stand}. The rest of the bet I'll collect myself.",
    "WETTE_VERFALLEN_SUB": "⌛ No report on the bet – that counts as lost. {einsatz} points gone, balance {stand}.",
    ...
    "BUTTON_WETTE_ABLEHNEN": "❌ Decline",
    "WETTE_ANTWORT_VERALTET": "This bet is no longer open.",
    "WETTE_ANGENOMMEN_SUB": "✅ Accepted. Verdict in {tage} day(s) – {einsatz} points are at stake.",
    "WETTE_AUTO_ANGENOMMEN_SUB": "⌛ No answer to the bet – it counts as accepted. Verdict in {tage} day(s).",
    "WETTE_ANGENOMMEN_DOM": "✅ {sub_gross} accepted the bet{zusatz} – verdict on {datum}.",
    "WETTE_AUTOMATISCH_ZUSATZ": " (no answer, automatically)",
    "WETTE_ERINNERUNG_SUB": "🎲 Your Mistress is still waiting for your answer to the bet. In {stunden} hours it counts as accepted.",
    "WETTE_ABGELEHNT_SUB": "❌ Declined. What that costs you is up to your Mistress.",
    "WETTE_ABGELEHNT_DOM": "❌ {sub_gross} declined the bet. What does that cost him?",
    "WETTE_ABLEHNUNG_ABZUG_DOM": "❌ {sub_gross} declined the bet – {betrag} points deducted, balance {stand}.",
    "WETTE_STRAFE_SUCHT": "🎲 One moment, picking three fitting punishments …",
    "WETTE_STRAFE_SUCHT_TOAST": "🎲 Picking punishments – takes a minute or two …",
    "WETTE_STRAFE_WAHL": "Which punishment does he get for it?",
    "WETTE_STRAFE_KEINE_VORSCHLAEGE": "Nothing fitting comes to mind right now – roll again, write your own or leave it at the points.",
    "BUTTON_WETTE_STRAFE_NEU": "🎲 New",
    "BUTTON_WETTE_STRAFE_EIGENE": "✍️ Own",
    "BUTTON_WETTE_STRAFE_KEINE": "🚫 Points only",
    "WETTE_STRAFE_EIGENE_FRAGE": "✍️ Write me the punishment – I'll phrase it in your voice and set it as a task for him.",
    "WETTE_STRAFE_ANGEORDNET": "⚖️ Ordered – the punishment is set as a task for him:",
    "WETTE_STRAFE_KEINE": "🚫 Just the points – done.",
    "WETTE_STRAFE_LIMIT": "⛔ The punishment would touch limits ({begriffe}) – phrase it differently or take a suggestion.",
    "WETTE_STRAFE_FEHLER": "⚠️ That didn't work just now – try again in a moment.",
    "WETTE_STRAFE_NEU_LIMIT": "Three new rounds are enough – take a suggestion, write your own or leave it at the points.",
    "WETTE_ABLEHNUNG_VERALTET": "This decline has already been handled.",
    "WETTE_ABZUG_SUB": "❌ {betrag} points for declining. Balance {stand}. The punishment is still to come.",
    "WETTE_ABLEHNUNG_AUTO_SUB": "⌛ {betrag} points for declining the bet. Balance {stand}.",
    "WETTE_STRAFE_PROTOKOLL": "Bet declined",
    "WETTE_LAGE_ANGEBOTEN": "it's waiting for his answer",
    "WETTE_LAGE_LAEUFT": "it's running, verdict on {datum}",
    "WETTE_LAGE_ABGELEHNT": "he declined, your decision on the punishment is still open",
    "WETTE_ABRUF_OFFEN": "🎲 A bet is still open – {lage}. The next one comes after that.",
    "WETTE_ABRUF_DENKT": "🎲 One moment, thinking up a bet{thema} – takes a minute or two …",
    "WETTE_ABRUF_THEMA": " around “{thema}”",
    "WETTE_ABRUF_FEHLER": "⚠️ Nothing usable came out just now – tap /bet again in a moment.",
    "SESSION_WUNSCH_AUFGABE": "Session by wish (privilege): a session from his wish categories – {kategorien}. The dominant sets the date.",
    "SESSION_WUNSCH_OHNE_KATEGORIE": "wish categories not set yet (/wunschkategorien)",
    "COACH_WETTIDEE_LAEUFT": "A bet is still open – the next one comes once that one is settled.",
    ...
    "COACH_WETTIDEE_GESENDET": "📨 Sent – now he has to accept or decline ({einsatz} points at stake). I'll let you know.",
