...
MESSAGES = {
    ...
    "WETTE_STRAFE_SUCHT_TOAST": "🎲 Ich such Strafen raus – dauert bis zu einer Minute …",
    ...
    "WETTE_ABRUF_DENKT": "🎲 Moment, ich denk mir eine Wette aus{thema} – dauert bis zu einer Minute …",
