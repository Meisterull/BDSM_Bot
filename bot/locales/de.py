...
MESSAGES = {
    ...
    "COACH_WETTIDEE_LAEUFT": "Es läuft noch eine Wette – erst wenn die entschieden ist, kommt die nächste.",
    ...
    "COACH_WETTIDEE_GESENDET": "📨 Ist raus – die Wette liegt jetzt bei ihm. Urteil in {tage} Tag(en), {einsatz} Punkte obendrauf.",
