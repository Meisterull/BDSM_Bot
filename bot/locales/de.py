...
MESSAGES = {
    ...
    # --- Währung ⭐ (16.09.2026): Ränge, Abzüge, Schwellen-Push, Sparziel, Herrin-Wette ---
    "RANG_ZEILE_MIT_NAECHSTEM": "{titel} · nächster Rang {naechster} ab {ab} Punkten",
    "RANG_ZEILE_HOECHSTER": "{titel} · höchster Rang",
    "SPARZIEL_ZEILE": "{wunsch} · {stand}/{preis} P",
    "RANG_AUF": "🏅 Du steigst auf: {titel} ({stand} Punkte). Ich sehe das. Bild dir nichts drauf ein.",
    "RANG_AB": "📉 Du fällst zurück auf {titel} ({stand} Punkte). Das hast du dir selbst eingebrockt.",
    "SCHWELLE_KOPF": "⭐ {stand} Punkte, die {schwelle} sind voll. Rang: {rang}.",
    "SCHWELLE_SPARZIEL": "🎯 Sparziel: {zeile}",
    "SCHWELLE_SHOP": "Wenn du sie ausgeben willst, hier die zwei teuersten Dinge, die du dir leisten kannst. Sonst spar weiter.",
    "BUTTON_ABZUG": "−{betrag} P",
    "ABZUG_VERALTET": "Der Abzug ist nicht mehr möglich – schon gebucht oder zu alt.",
    "ABZUG_DOM_OK": "⭐ {betrag} Punkte abgezogen, er steht jetzt bei {stand}.",
    "ABZUG_SUB": "📉 Ich habe dir {betrag} Punkte abgezogen. Stand: {stand}. Merk dir, wofür.",
    "ABZUG_NICHT_ERLEDIGT_ZEILE": "📉 Das kostet dich {betrag} Punkte. Stand: {stand}.",
    "WUNSCHPREIS_FRAGE": "🛒 Neuer Wunsch von {sub_nom}: „{wunsch}“\n\nWas soll er dafür sparen? Ohne deinen Tipp bleibt es ein Wunsch ohne Preis.",
    "WUNSCHPREIS_VERALTET": "Diese Wunsch-Frage ist nicht mehr aktuell.",
    "WUNSCHPREIS_WEG": "Der Wunsch „{wunsch}“ steht nicht mehr auf der Liste.",
    "WUNSCHPREIS_GESETZT": "🎯 „{wunsch}“ kostet ihn jetzt {preis} Punkte. Sobald er sie zusammen hat, frage ich dich.",
    "SPARZIEL_NEU_SUB": "🎯 Dein Sparziel: „{wunsch}“ für {preis} Punkte. Du stehst bei {stand}.",
    "SPARZIEL_ERREICHT": "🎯 {sub_nom} hat {preis} Punkte für „{wunsch}“ zusammen (Stand {stand}).\n\nGewähren? Dann buche ich die Punkte ab und er weiß, dass es kommt.",
    "BUTTON_SPARZIEL_GEWAEHREN": "✅ Gewähren",
    "BUTTON_SPARZIEL_SPAETER": "⏳ Noch nicht",
    "SPARZIEL_VERALTET": "Diese Frage ist nicht mehr aktuell.",
    "SPARZIEL_SPAETER": "👍 Bleibt offen – ich frage frühestens in {tage} Tagen wieder.",
    "SPARZIEL_WEG": "Der Wunsch „{wunsch}“ hat keinen Preis mehr oder steht nicht mehr auf der Liste.",
    "SPARZIEL_ZU_WENIG": "Er hat für „{wunsch}“ nicht mehr genug: {stand} von {preis} Punkten.",
    "SPARZIEL_GEWAEHRT_DOM": "✅ Gewährt: „{wunsch}“ für {preis} Punkte, er steht jetzt bei {stand}. Sobald es da ist, trag es mit „+ …“ ins Inventar.",
    "SPARZIEL_GEWAEHRT_SUB": "🎁 Du hast dir „{wunsch}“ erspart – {preis} Punkte sind weg, Stand {stand}. Wann und wie du es bekommst, entscheide ich.",
    "WETTE_URTEIL_FRAGE": "🎲 Die Frist deiner Wette ist um. Und? Ehrlich – ich erfahre es sowieso. ({einsatz} Punkte stehen drauf.)",
    "BUTTON_WETTE_GEWONNEN": "🏆 Gewonnen",
    "BUTTON_WETTE_VERLOREN": "💀 Verloren",
    "WETTE_URTEIL_VERALTET": "Diese Wette ist schon entschieden.",
    "WETTE_GEWONNEN_SUB": "🏆 Gewonnen. {einsatz} Punkte dazu, Stand {stand}. Genieß es, so oft passiert das nicht.",
    "WETTE_VERLOREN_SUB": "💀 Verloren. {einsatz} Punkte weg, Stand {stand}. Den Rest der Wette treibe ich ein.",
    "WETTE_VERFALLEN_SUB": "⌛ Keine Meldung zur Wette – das zählt als verloren. {einsatz} Punkte weg, Stand {stand}.",
    ...
    "BUTTON_WETTE_ABLEHNEN": "❌ Ablehnen",
    "WETTE_ANTWORT_VERALTET": "Diese Wette ist nicht mehr offen.",
    "WETTE_ANGENOMMEN_SUB": "✅ Angenommen. Urteil in {tage} Tag(en) – {einsatz} Punkte stehen drauf.",
    "WETTE_AUTO_ANGENOMMEN_SUB": "⌛ Keine Antwort auf die Wette – sie gilt als angenommen. Urteil in {tage} Tag(en).",
    "WETTE_ANGENOMMEN_DOM": "✅ {sub_gross} hat die Wette angenommen{zusatz} – Urteil am {datum}.",
    "WETTE_AUTOMATISCH_ZUSATZ": " (keine Antwort, automatisch)",
    "WETTE_ERINNERUNG_SUB": "🎲 Deine Herrin wartet noch auf deine Antwort zur Wette. In {stunden} Stunden gilt sie als angenommen.",
    "WETTE_ABGELEHNT_SUB": "❌ Abgelehnt. Was dich das kostet, entscheidet deine Herrin.",
    "WETTE_ABGELEHNT_DOM": "❌ {sub_gross} hat die Wette abgelehnt. Was kostet ihn das?",
    "WETTE_ABLEHNUNG_ABZUG_DOM": "❌ {sub_gross} hat die Wette abgelehnt – {betrag} Punkte abgezogen, Stand {stand}.",
    "WETTE_STRAFE_SUCHT": "🎲 Moment, ich such drei passende Strafen raus …",
    "WETTE_STRAFE_SUCHT_TOAST": "🎲 Ich such Strafen raus – dauert ein bis zwei Minuten …",
    "WETTE_STRAFE_WAHL": "Welche Strafe bekommt er dafür?",
    "WETTE_STRAFE_KEINE_VORSCHLAEGE": "Mir fällt gerade nichts Passendes ein – würfel neu, schreib eine eigene oder lass es bei den Punkten.",
    "BUTTON_WETTE_STRAFE_NEU": "🎲 Neue",
    "BUTTON_WETTE_STRAFE_EIGENE": "✍️ Eigene",
    "BUTTON_WETTE_STRAFE_KEINE": "🚫 Nur Punkte",
    "WETTE_STRAFE_EIGENE_FRAGE": "✍️ Schreib mir die Strafe – ich formulier sie in deiner Stimme und leg sie ihm als Aufgabe hin.",
    "WETTE_STRAFE_ANGEORDNET": "⚖️ Angeordnet – die Strafe liegt als Aufgabe bei ihm:",
    "WETTE_STRAFE_KEINE": "🚫 Nur die Punkte – erledigt.",
    "WETTE_STRAFE_LIMIT": "⛔ Die Strafe würde Grenzen berühren ({begriffe}) – schreib sie anders oder nimm einen Vorschlag.",
    "WETTE_STRAFE_FEHLER": "⚠️ Hat gerade nicht geklappt – probier es gleich nochmal.",
    "WETTE_STRAFE_NEU_LIMIT": "Drei neue Runden reichen – nimm einen Vorschlag, schreib eine eigene oder lass es bei den Punkten.",
    "WETTE_ABLEHNUNG_VERALTET": "Diese Ablehnung ist schon erledigt.",
    "WETTE_ABZUG_SUB": "❌ {betrag} Punkte fürs Ablehnen. Stand {stand}. Die Strafe kommt noch.",
    "WETTE_ABLEHNUNG_AUTO_SUB": "⌛ {betrag} Punkte fürs Ablehnen der Wette. Stand {stand}.",
    "WETTE_STRAFE_PROTOKOLL": "Wette abgelehnt",
    "WETTE_LAGE_ANGEBOTEN": "sie wartet auf seine Antwort",
    "WETTE_LAGE_LAEUFT": "sie läuft, Urteil am {datum}",
    "WETTE_LAGE_ABGELEHNT": "er hat abgelehnt, deine Entscheidung zur Strafe steht noch aus",
    "WETTE_ABRUF_OFFEN": "🎲 Es ist noch eine Wette offen – {lage}. Erst danach kommt die nächste.",
    "WETTE_ABRUF_DENKT": "🎲 Moment, ich denk mir eine Wette aus{thema} – dauert ein bis zwei Minuten …",
    "WETTE_ABRUF_THEMA": " rund um „{thema}“",
    "WETTE_ABRUF_FEHLER": "⚠️ Gerade kam nichts Brauchbares raus – tipp /wette gleich nochmal.",
    "SESSION_WUNSCH_AUFGABE": "Session nach Wunsch (Privileg): eine Session aus seinen Wunsch-Kategorien – {kategorien}. Termin bestimmt die Herrin.",
    "SESSION_WUNSCH_OHNE_KATEGORIE": "Wunsch-Kategorien noch nicht gesetzt (/wunschkategorien)",
    "COACH_WETTIDEE_LAEUFT": "Es ist noch eine Wette offen – erst wenn die erledigt ist, kommt die nächste.",
    ...
    "COACH_QUIZ_VERFALLEN": "🕰 Kein Stress – die Quiz-Frage von vorhin lasse ich dir durchgehen. Damit du sie trotzdem mitnimmst:\n\n❓ {frage}\n➡️ _{muster}_\n\n📚 {aufloesung}\n\n_Das Thema kommt irgendwann nochmal dran._",
    ...
    "COACH_WETTIDEE_GESENDET": "📨 Ist raus – jetzt muss er annehmen oder ablehnen ({einsatz} Punkte stehen drauf). Ich sag dir Bescheid.",
